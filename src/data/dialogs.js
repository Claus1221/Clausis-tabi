...
export const DIALOGS = [
  ...
  { id: 'd1', title: 'Begrüßung', goal: 'Begrüße jemanden und stell dich vor.', emoji: 'hello', scaffold: 'voll', turns: [
    { npc: 'こんにちは！', de: 'Guten Tag!', options: ['こんにちは。', 'さようなら。', 'すみません。'], answer: 'こんにちは。', answerDe: 'Guten Tag.' },
    { npc: 'おなまえは？', de: 'Wie heißen Sie?', options: ['クラウスです。', 'いくらですか？', 'みぎです。'], answer: 'クラウスです。', answerDe: 'Ich bin Klaus.' },
    { npc: 'どちらから？', de: 'Woher kommen Sie?', options: ['ドイツからです。', 'たべます。', 'たかいです。'], answer: 'ドイツからです。', answerDe: 'Ich komme aus Deutschland.' },
  ] },
  { id: 'd2', title: 'Mit dem Taxi', goal: 'Lass dich zum Hotel fahren.', emoji: 'taxi', scaffold: 'voll', turns: [
    { npc: 'どちらまで？', de: 'Wohin?', options: ['ホテルまで おねがいします。', 'いただきます。', 'おやすみなさい。'], answer: 'ホテルまで おねがいします。', answerDe: 'Zum Hotel, bitte.' },
    { npc: 'わかりました。', de: 'Verstanden.', options: ['ありがとうございます。', 'たすけて！', 'たかいです。'], answer: 'ありがとうございます。', answerDe: 'Vielen Dank.' },
    { npc: 'つきましたよ。', de: 'Wir sind da.', options: ['いくらですか？', 'おはよう。', 'さかなです。'], answer: 'いくらですか？', answerDe: 'Was kostet das?' },
  ] },
  { section: 'ホテル', sub: 'Im Hotel' },
  { id: 'd3', title: 'Check-in', goal: 'Checke im Hotel ein.', emoji: 'hotel', scaffold: 'voll', turns: [
    { npc: 'いらっしゃいませ。', de: 'Willkommen.', options: ['チェックイン おねがいします。', 'メニューを ください。', 'みぎです。'], answer: 'チェックイン おねがいします。', answerDe: 'Einchecken, bitte.' },
    { npc: 'おなまえを おねがいします。', de: 'Ihren Namen, bitte.', options: ['クラウスです。', 'みずです。', 'やすいです。'], answer: 'クラウスです。', answerDe: 'Ich bin Klaus.' },
    { npc: 'パスポートを おねがいします。', de: 'Ihren Pass, bitte.', options: ['はい、どうぞ。', 'いいえ、けっこうです。', 'たべません。'], answer: 'はい、どうぞ。', answerDe: 'Ja, bitte sehr.' },
  ] },
  ...
  { id: 'd4', title: 'Im Restaurant', goal: 'Bestelle Essen und bitte um die Rechnung.', emoji: 'food', scaffold: 'mittel', turns: [
    { npc: 'いらっしゃいませ！', de: 'Willkommen!', options: ['こんにちは。', 'さようなら。', 'いくらですか？'], answer: 'こんにちは。', answerDe: 'Guten Tag.' },
    { npc: 'ごちゅうもんは？', de: 'Ihre Bestellung?', options: ['メニューを ください。', 'たすけて！', 'みぎです。'], answer: 'メニューを ください。', answerDe: 'Die Speisekarte, bitte.' },
    { npc: 'おのみものは？', de: 'Etwas zu trinken?', options: ['おみずを ください。', 'さようなら。', 'わかりません。'], answer: 'おみずを ください。', answerDe: 'Wasser, bitte.' },
    { npc: 'はい、なんでしょう？', de: 'Ja, bitte?', options: ['おかいけい おねがいします。', 'こんばんは。', 'たかいです。'], answer: 'おかいけい おねがいします。', answerDe: 'Die Rechnung, bitte.' },
  ] },
  { id: 'd5', title: 'Im Café', goal: 'Bestelle einen Kaffee.', emoji: 'coffee', scaffold: 'mittel', turns: [
    { npc: 'いらっしゃいませ。', de: 'Willkommen.', options: ['コーヒーを ください。', 'えきは どこですか？', 'たすけて！'], answer: 'コーヒーを ください。', answerDe: 'Einen Kaffee, bitte.' },
    { npc: 'ホットですか、アイスですか？', de: 'Heiß oder kalt?', options: ['ホットで おねがいします。', 'みぎです。', 'さようなら。'], answer: 'ホットで おねがいします。', answerDe: 'Heiß, bitte.' },
    { npc: 'いじょうで よろしいですか？', de: 'Ist das alles?', options: ['はい、いじょうです。', 'いくらですか？', 'たべません。'], answer: 'はい、いじょうです。', answerDe: 'Ja, das ist alles.' },
  ] },
  ...
  { id: 'd6', title: 'Nach dem Weg fragen', goal: 'Finde den Bahnhof.', emoji: 'map', scaffold: 'mittel', turns: [
    { npc: 'はい、なんでしょう？', de: 'Ja, bitte?', options: ['すみません、えきは どこですか？', 'いただきます。', 'おやすみなさい。'], answer: 'すみません、えきは どこですか？', answerDe: 'Entschuldigung, wo ist der Bahnhof?' },
    { npc: 'まっすぐ、それから みぎです。', de: 'Geradeaus, dann rechts.', options: ['ありがとうございます。', 'いくらですか？', 'たべません。'], answer: 'ありがとうございます。', answerDe: 'Vielen Dank.' },
    { npc: 'きを つけて！', de: 'Pass auf dich auf!', options: ['さようなら。', 'メニューを ください。', 'みぎです。'], answer: 'さようなら。', answerDe: 'Auf Wiedersehen.' },
  ] },
  { id: 'd7', title: 'Zugticket kaufen', goal: 'Kaufe ein Ticket nach Tokyo.', emoji: 'train', scaffold: 'mittel', turns: [
    { npc: 'どちらまで？', de: 'Bis wohin?', options: ['とうきょうまで おねがいします。', 'コーヒーを ください。', 'たすけて！'], answer: 'とうきょうまで おねがいします。', answerDe: 'Nach Tokyo, bitte.' },
    { npc: 'かたみちですか、おうふくですか？', de: 'Einfach oder hin und zurück?', options: ['かたみちで おねがいします。', 'みぎです。', 'さようなら。'], answer: 'かたみちで おねがいします。', answerDe: 'Einfach, bitte.' },
    { npc: 'にせんえんです。', de: 'Das macht 2000 Yen.', options: ['はい、どうぞ。', 'わかりません。', 'たかいです。'], answer: 'はい、どうぞ。', answerDe: 'Ja, bitte sehr.' },
  ] },
  { section: '買い物', sub: 'Einkaufen' },
  { id: 'd8', title: 'Im Laden', goal: 'Frag nach dem Preis und bezahle.', emoji: 'person', scaffold: 'frei', turns: [
    { npc: 'いらっしゃいませ。', de: 'Willkommen.', options: ['これは いくらですか？', 'えきは どこですか？', 'たすけて！', 'おやすみなさい。'], answer: 'これは いくらですか？', answerDe: 'Was kostet das hier?' },
    { npc: 'せんえんです。', de: '1000 Yen.', options: ['じゃあ、これを ください。', 'メニューを ください。', 'みぎです。', 'たべません。'], answer: 'じゃあ、これを ください。', answerDe: 'Dann nehme ich das, bitte.' },
    { npc: 'カードで よろしいですか？', de: 'Mit Karte in Ordnung?', options: ['はい、おねがいします。', 'いいえ、けっこうです。', 'えきは どこですか？', 'さようなら。'], answer: 'はい、おねがいします。', answerDe: 'Ja, bitte.' },
    { npc: 'ありがとうございました。', de: 'Vielen Dank.', options: ['どうも。', 'いただきます。', 'たかいです。', 'わかりません。'], answer: 'どうも。', answerDe: 'Danke.' },
  ] },
  ...
  { id: 'd9', title: 'Um Hilfe bitten', goal: 'Du hast dich verlaufen – bitte um Hilfe.', emoji: 'hand', scaffold: 'frei', turns: [
    { npc: 'だいじょうぶですか？', de: 'Geht es Ihnen gut?', options: ['みちに まよいました。', 'いただきます。', 'おいしいです。', 'こんばんは。'], answer: 'みちに まよいました。', answerDe: 'Ich habe mich verlaufen.' },
    { npc: 'どうしましたか？', de: 'Was ist passiert?', options: ['ホテルが わかりません。', 'メニューを ください。', 'みぎです。', 'たべます。'], answer: 'ホテルが わかりません。', answerDe: 'Ich finde mein Hotel nicht.' },
    { npc: 'いっしょに いきましょう。', de: 'Gehen wir zusammen.', options: ['ありがとうございます、たすかります。', 'いくらですか？', 'さようなら。', 'たかいです。'], answer: 'ありがとうございます、たすかります。', answerDe: 'Vielen Dank, das hilft mir sehr.' },
  ] },
]
