...
export const CHAPTERS = [
  ...
  { id: 'c3', title: 'In die Natur', steps: [
    ...
    { kind: 'intro', emoji: 'sky', jp: '空', reading: 'そら', de: 'Himmel' },
  ...
  { id: 'c4', title: 'Begegnungen', steps: [
    ...
    { kind: 'sign', sign: 'アイス', prompt: 'An einem Automaten: アイス. Das ist…', options: ['Eis', 'Tee', 'Milch'], answer: 'Eis' },
    { kind: 'build', prompt: 'Bilde: „Der Hund rennt."', tiles: ['犬', 'が', '走ります'], answer: ['犬', 'が', '走ります'], tr: '犬が走ります。' },
    { kind: 'gap', text: '魚＿見ます。', prompt: 'Welche Partikel markiert das Objekt?', options: ['を', 'が', 'に'], answer: 'を', hint: 'を markiert das Objekt.' },
    { kind: 'build', prompt: 'Bilde: „Die Katze sieht den Fisch."', tiles: ['猫', 'が', '魚', 'を', '見ます'], answer: ['猫', 'が', '魚', 'を', '見ます'], tr: '猫が魚を見ます。' },
    { kind: 'story', emoji: 'dog', text: 'Neu: Bei Lebewesen (Menschen, Tiere) heißt „es gibt / da sein" 〜が います. 犬が います＝„Da ist ein Hund."' },
  ...
  { id: 'c7', title: 'Ankunft in Tokyo', steps: [
    ...
    { kind: 'intro', emoji: 'door', jp: '出口', reading: 'でぐち', de: 'Ausgang' },
    ...
    { kind: 'intro', emoji: 'right', jp: '右', reading: 'みぎ', de: 'rechts' },
    { kind: 'intro', emoji: 'left', jp: '左', reading: 'ひだり', de: 'links' },
  ...
  { id: 'c8', title: 'Im Restaurant', steps: [
    ...
    { kind: 'intro', emoji: 'restaurant', jp: 'レストラン', reading: 'レストラン', de: 'Restaurant' },
  ...
  { id: 'c9', title: 'Im Konbini', steps: [
    ...
    { kind: 'intro', emoji: 'elephant', jp: '大きい', reading: 'おおきい', de: 'groß' },
    { kind: 'intro', emoji: 'ant', jp: '小さい', reading: 'ちいさい', de: 'klein' },
    { kind: 'audio', say: 'ちいさい', options: ['小さい', '大きい', '高い'], answer: '小さい', de: 'klein' },
    { kind: 'story', emoji: 'water', text: 'Neu: Bei Dingen heißt „es gibt ~" 〜が あります (bei Lebewesen, schon bekannt: 〜が います). 水が あります = „es gibt Wasser". Mit か wird daraus die Frage: 水が ありますか？' },
  ...
  { id: 'c10', title: 'Mit der U-Bahn', steps: [
    ...
    { kind: 'intro', emoji: 'up', jp: '上', reading: 'うえ', de: 'oben' },
    { kind: 'intro', emoji: 'down', jp: '下', reading: 'した', de: 'unten' },
  ...
  { id: 'c11', title: 'Schilder lesen', steps: [
    ...
    { kind: 'intro', emoji: 'man', jp: '男', reading: 'おとこ', de: 'Mann' },
    { kind: 'intro', emoji: 'woman', jp: '女', reading: 'おんな', de: 'Frau' },
    { kind: 'intro', emoji: 'restroom', jp: 'トイレ', reading: 'トイレ', de: 'Toilette' },
  ...
  { id: 'c12', title: 'Beim Tempel', steps: [
    ...
    { kind: 'intro', emoji: 'camera', jp: 'カメラ', reading: 'カメラ', de: 'Kamera' },
  ...
  { id: 'c13', title: 'Himmelsrichtungen', steps: [
    ...
    { kind: 'intro', emoji: 'up', jp: '北', reading: 'きた', de: 'Norden' },
    { kind: 'intro', emoji: 'down', jp: '南', reading: 'みなみ', de: 'Süden' },
    { kind: 'intro', emoji: 'right', jp: '東', reading: 'ひがし', de: 'Osten' },
    { kind: 'intro', emoji: 'left', jp: '西', reading: 'にし', de: 'Westen' },
  ...
  { id: 'c14', title: 'Im Tempelgarten', steps: [
    ...
    { kind: 'story', emoji: 'torii', text: 'Schon bekannt: Bei Lebewesen heißt „es gibt / ist da" 〜が います (bei Dingen 〜が あります). Auch bekannt: 〜の上に＝auf/über ~, 〜の下に＝unter ~, 〜の中に＝in ~. Neu dazu: 〜の前に／後ろに／隣に＝vor／hinter／neben ~.' },
    ...
    { kind: 'tf', emoji: 'cat', jp: '猫がいます。', prompt: 'Stimmt es zum Bild?', answer: true },
  ...
  { id: 'c15', title: 'Souvenirs kaufen', steps: [
    ...
    { kind: 'intro', emoji: 'gift', jp: 'お土産', reading: 'おみやげ', de: 'Souvenir' },
